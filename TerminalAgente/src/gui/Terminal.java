		...
		botonConfirm.addActionListener(new ActionListener() {
			  public void actionPerformed(ActionEvent eve)
			  {
				  try {
					  ...
					  mensajeError.setText("Se ha creado el ticket " + t.getTicketNumber() + " para la matrícula " + t.getPlate() );
					  mensajeError2.setForeground(Color.BLACK);
					  mensajeError2.setText("por " + t.getMinutes() + " minutos desde las " + t.getStartDateTime() + "horas");	
